...
$query = "SELECT * FROM cars WHERE sold = '0' HAVING MSRP <= ALL (select MSRP FROM cars);"; 
...
echo "<tr><td>" . $row['vin'] . "</td><td>" . $row['model'] . "</td><td>" . $row['edition'] . "</td><td>" . $row['year'] . "</td><td>" . $row['miles'] . "</td><td>" . $row['MSRP'] . "</td></tr>";  //$row['index'] the index here is a field name
}
